      ...
      <div className="grid gap-6 md:grid-cols-3">
        ...
        <form onSubmit={handleAddNote} className="rounded-2xl border border-border bg-card p-5 shadow-sm space-y-4">
          ...
          <button
            type="submit"
            disabled={saving}
            className="w-full flex items-center justify-center gap-2 rounded-lg bg-primary py-2.5 text-sm font-semibold text-primary-foreground disabled:opacity-50 hover:bg-primary/90 transition-colors"
          >
